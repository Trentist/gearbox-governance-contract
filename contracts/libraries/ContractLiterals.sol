...
bytes32 constant AP_CHAIN_SIGNATURE_MULTISIG = "CHAIN_SIGNATURE_MULTISIG";
...
bytes32 constant AP_POOL_FACTORY = "FACTORY_POOL";
bytes32 constant AP_CREDIT_FACTORY = "FACTORY_CREDIT";
bytes32 constant AP_INTEREST_RATE_MODEL_FACTORY = "FACTORY_INTEREST_RATE_MODEL";
bytes32 constant AP_PRICE_ORACLE_FACTORY = "FACTORY_PRICE_ORACLE";
bytes32 constant AP_RATE_KEEPER_FACTORY = "FACTORY_RATE_KEEPER";
bytes32 constant AP_LOSS_POLICY_FACTORY = "FACTORY_LOSS_POLICY";
bytes32 constant AP_MARKET_CONFIGURATOR_FACTORY = "FACTORY_MARKET_CONFIGURATOR";
