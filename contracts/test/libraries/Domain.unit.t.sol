...
contract DomainUnitTest is Test {
    ...
    function test_Domain_01_extracts_domain_with_separator() public {
    ...
    function test_Domain_03_extracts_empty_domain_from_empty_string() public {
        string memory input = "";
        string memory domain = Domain.extractDomain(input);
        assertEq(domain, "");
    }
    ...
    function test_Domain_04_extracts_first_domain_with_multiple_separators() public {
